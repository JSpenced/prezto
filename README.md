...
02. Clone the repository:
    ...
    ```console
    git clone --recurse-submodules -j8 -b macbook https://github.com/JspenceD/prezto.git "${ZDOTDIR:-$HOME}/.zprezto"
    ```  
	
    or use the following for ssh:  
	
    ```console
    git clone --recurse-submodules -j8 -b macbook git@github.com:JSpenced/prezto.git "${ZDOTDIR:-$HOME}/.zprezto"
    ```  
